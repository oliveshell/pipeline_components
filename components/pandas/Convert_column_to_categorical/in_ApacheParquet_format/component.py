...
if __name__ == "__main__":
    convert_column_to_categorical_using_Pandas_on_ApacheParquet_data_op = create_component_from_func(
        ...
        annotations={
            ...
            "canonical_location": "https://raw.githubusercontent.com/oliveshell/pipeline_components/master/components/pandas/Convert_column_to_categorical/in_ApacheParquet_format/component.yaml",
        },
    )
