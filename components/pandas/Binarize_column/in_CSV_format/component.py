...
if __name__ == "__main__":
    binarize_column_using_Pandas_on_CSV_data_op = create_component_from_func(
        ...
        annotations={
            ...
            "canonical_location": "https://raw.githubusercontent.com/oliveshell/pipeline_components/master/components/pandas/Binarize_column/in_CSV_format/component.yaml",
        },
    )
