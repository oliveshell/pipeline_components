...
if __name__ == "__main__":
    select_columns_using_Pandas_on_ApacheParquet_data_op = create_component_from_func(
        ...
        annotations={
            ...
            "canonical_location": "https://raw.githubusercontent.com/oliveshell/pipeline_components/master/components/pandas/Select_columns/in_ApacheParquet_format/component.yaml",
        },
    )
