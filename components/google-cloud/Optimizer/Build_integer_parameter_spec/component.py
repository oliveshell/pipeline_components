...
if __name__ == '__main__':
    build_integer_parameter_spec_for_Google_Cloud_AI_Platform_Optimizer_op = create_component_from_func(
        ...
        annotations={
            ...
            "canonical_location": "https://raw.githubusercontent.com/oliveshell/pipeline_components/master/components/google-cloud/Optimizer/Build_integer_parameter_spec/component.yaml",
        },
    )
