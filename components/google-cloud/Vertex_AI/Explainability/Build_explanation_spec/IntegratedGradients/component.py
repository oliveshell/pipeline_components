...
if __name__ == "__main__":
    build_IntegratedGradients_explanation_spec_for_Vertex_AI_op = create_component_from_func(
        ...
        annotations={
            ...
            "canonical_location": "https://raw.githubusercontent.com/oliveshell/pipeline_components/master/components/google-cloud/Vertex_AI/Explainability/Build_explanation_spec/IntegratedGradients/component.yaml",
        },
    )
